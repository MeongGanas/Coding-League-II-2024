...
export default function Index({ auth: { user }, proyeks, sektors, possibleYear, notifications }: PageProps<{ proyeks: ProyekProps, sektors: Sektor[], possibleYear: any, notifications: any }>) {
    return (
