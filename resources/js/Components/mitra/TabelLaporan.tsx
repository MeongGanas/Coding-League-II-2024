...
const tableHeader = [
    ...
    { title: "Laporan Dikirim", sortable: true, sortKey: "created_at" },
    { title: "Status", sortable: true, sortKey: "status" },
    { title: "Aksi", className: "text-center" },
];

export default function DataTableLaporanMitra({
    laporans,
}: {
                    ...
                    <TableBody>
                        {laporans.data.length > 0 ? (
                            laporans.data.map((laporan) => (
                                <TableRow
                                    className="odd:bg-[#FCFCFD] even:bg-white"
                                    key={laporan.id}
                                >
